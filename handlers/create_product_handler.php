...
if (check_method('POST')) {
    ...
    if ($img_name === '') {
        $errors[] = 'product img is empty, upload product img please';
    } else {
    ...
    if (!empty($errors)) {
        ...
        redirect("../product/create_product.php");
    } else {
        createProduct($product_name, $product_price, $product_description, $new_name);
